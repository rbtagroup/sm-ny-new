...
export function createSupabaseMappers({ uid, timePart }) {
  ...
  const toDb = {
    ...
    notifications: (n) => stripUndefined({ id: normalizeId(n.id, 'ntf'), target_driver_id: n.targetDriverId || null, target_role: n.targetRole || 'admin', type: n.type || 'info', shift_id: n.shiftId || null, title: n.title || '', body: n.body || null, read_by: n.readBy || [], deleted_by: n.deletedBy || [], created_at: n.at || n.createdAt || new Date().toISOString() }),
  ...
  const fromDb = {
    ...
    notifications: (n) => ({ id: n.id, at: n.created_at, title: n.title || '', body: n.body || '', targetDriverId: n.target_driver_id || '', targetRole: n.target_role || 'admin', type: n.type || 'info', shiftId: n.shift_id || '', readBy: n.read_by || [], deletedBy: n.deleted_by || [] }),
