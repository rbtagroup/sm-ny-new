...
.driver-actions{grid-template-columns:repeat(2,minmax(0,1fr));gap:10px}.driver-actions .driver-primary-action{grid-column:1/-1;width:100%;min-height:58px}.driver-quick-strip:empty{display:none}.quick-chip{cursor:pointer}.quick-chip:focus-visible{outline:2px solid rgba(245,199,106,.55);outline-offset:2px}.driver-open-shifts-highlight{border-color:rgba(255,207,90,.55);background:linear-gradient(180deg,rgba(255,207,90,.12),rgba(255,255,255,.035))}.driver-calendar-card .section-title .pill{cursor:pointer}
...
.driver-topbar-brand{display:flex;align-items:center;gap:10px;min-width:0}.driver-topbar-brand strong{display:block;font-size:16px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.driver-topbar-brand small{display:block;color:var(--muted);font-size:12px}.compact-logo{width:38px;height:38px;border-radius:14px;flex:0 0 auto}.driver-avatar-img{width:38px;height:38px;border-radius:14px;object-fit:cover;flex:0 0 auto;border:1px solid rgba(245,199,106,.35)}.driver-main-v2{width:100%;max-width:820px;margin:0 auto;padding:14px max(14px,env(safe-area-inset-right,0px)) 18px max(14px,env(safe-area-inset-left,0px));overflow-x:hidden}.driver-main-v2.driver-main-settings{padding-top:calc(14px + env(safe-area-inset-top,0px))}.driver-bottom-nav{position:fixed;left:0;right:0;bottom:0;z-index:30;display:grid;grid-template-columns:repeat(4,1fr);gap:6px;padding:8px max(10px,env(safe-area-inset-right,0px)) calc(8px + env(safe-area-inset-bottom,0px)) max(10px,env(safe-area-inset-left,0px));background:rgba(8,17,31,.96);border-top:1px solid var(--line);backdrop-filter:blur(18px)}.driver-bottom-nav button{position:relative;border:1px solid transparent;background:transparent;color:var(--muted);border-radius:14px;padding:8px 4px 7px;display:grid;gap:2px;place-items:center}.driver-bottom-nav button span{line-height:1}.driver-bottom-nav button b{font-size:11px;font-weight:400}.driver-bottom-nav button.active{color:var(--text);background:rgba(255,255,255,.065);border-color:var(--line)}.driver-bottom-nav button.active b{font-weight:500}.driver-nav-icon{position:relative;width:24px;height:24px;display:grid;place-items:center}.driver-nav-icon svg{width:24px;height:24px;stroke-width:2}.driver-nav-icon em{position:absolute;top:-5px;right:-10px;min-width:18px;height:18px;padding:0 5px;border-radius:999px;background:rgba(255,207,90,.95);color:#07101d;font-style:normal;font-size:10px;font-weight:700;display:grid;place-items:center}.driver-priority-view{gap:12px}.driver-info-line{border:1px dashed rgba(255,255,255,.14);border-radius:14px;padding:10px 12px;color:var(--muted);background:rgba(255,255,255,.035);font-size:13px}.driver-calendar-card{overflow:hidden}.driver-week-block{display:grid;gap:8px;margin-top:12px}.driver-week-title{display:flex;justify-content:space-between;gap:8px;color:var(--muted);font-size:12px;font-weight:850;text-transform:uppercase;letter-spacing:.04em}.driver-week-title span{text-transform:none;letter-spacing:0;font-weight:700}.driver-week-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:6px}.driver-day{min-width:0;border:1px solid var(--line);border-radius:14px;background:rgba(255,255,255,.045);color:var(--text);padding:8px 3px;display:grid;place-items:center;gap:2px}.driver-day b{font-size:10px;color:var(--muted)}.driver-day strong{font-size:16px}.driver-day small{min-height:8px;display:flex;align-items:center;justify-content:center;gap:2px}.driver-cal-dot{display:inline-block;width:5px;height:5px;border-radius:999px;flex:0 0 auto}.driver-cal-dot.confirmed{background:var(--good)}.driver-cal-dot.open{background:var(--gold)}.driver-cal-dot.waiting{background:#d85a30}.driver-cal-dot.conflict{background:var(--bad)}.driver-cal-more{font-size:9px;line-height:1;color:var(--muted);font-weight:850}.driver-day.today{outline:2px solid rgba(245,199,106,.45);background:rgba(245,199,106,.10)}.driver-calendar-legend{display:flex;gap:12px;flex-wrap:wrap;color:var(--muted);font-size:12px;margin:10px 0}.driver-calendar-legend span{display:inline-flex;align-items:center;gap:5px}.driver-calendar-modal-backdrop{z-index:120;background:rgba(3,8,15,.90);backdrop-filter:blur(10px);padding:calc(18px + env(safe-area-inset-top,0px)) max(14px,env(safe-area-inset-right,0px)) calc(18px + env(safe-area-inset-bottom,0px)) max(14px,env(safe-area-inset-left,0px))}.driver-calendar-modal{width:min(560px,100%);max-height:calc(100vh - 34px);max-height:calc(100dvh - 34px);display:flex;flex-direction:column;overflow:hidden;background:#0b1423;border-color:rgba(255,255,255,.18);box-shadow:0 30px 90px rgba(0,0,0,.72)}.driver-calendar-modal .section-title{flex:0 0 auto}.driver-calendar-modal .section-title h3{font-size:24px}.driver-calendar-modal-close{width:42px!important;height:42px!important;min-height:0!important;padding:0!important;border-radius:14px!important;flex:0 0 auto}.driver-calendar-modal-body{overflow:auto;padding-right:2px}.driver-calendar-modal .driver-day{background:#101b2c}.toast-undo{position:sticky;top:calc(54px + env(safe-area-inset-top,0px));z-index:18;display:flex;align-items:center;justify-content:space-between;gap:10px;border:1px solid var(--line);border-radius:16px;padding:10px 12px;background:rgba(8,17,31,.94);box-shadow:var(--shadow);margin-bottom:12px}.notification-row{overflow:hidden}.notification-actions{justify-content:flex-end}.notification-actions .danger-mini{display:inline-flex;align-items:center;justify-content:center}.driver-settings-view{display:grid;gap:14px}.driver-settings-view .topbar{margin-bottom:0}
...
/* Výčetka integration */
.settlement-modal-backdrop{place-items:start center;overflow:hidden;overscroll-behavior:contain;padding:calc(12px + env(safe-area-inset-top,0px)) max(12px,env(safe-area-inset-right,0px)) calc(12px + env(safe-area-inset-bottom,0px)) max(12px,env(safe-area-inset-left,0px));background:rgba(3,8,15,.86);backdrop-filter:blur(10px)}
.settlement-modal{width:min(980px,100%);max-height:calc(100vh - 24px);max-height:calc(100dvh - env(safe-area-inset-top,0px) - env(safe-area-inset-bottom,0px) - 24px);overflow:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch;background:linear-gradient(180deg,#0d1828,#08111f);border-color:rgba(245,199,106,.24);box-shadow:0 34px 110px rgba(0,0,0,.78)}
.settlement-modal .section-title{position:sticky;top:0;z-index:2;margin:-18px -18px 14px;padding:16px 18px;border-bottom:1px solid rgba(255,255,255,.12);background:#0d1828}
.settlement-modal .section-title h3{min-width:0;font-size:clamp(20px,4vw,24px);line-height:1.12}.settlement-modal .section-title .ghost{flex:0 0 auto}.settlement-modal input,.settlement-modal select,.settlement-modal textarea,.settlement-modal button{font-size:16px}
...
@media (max-width:560px){.settlement-modal-backdrop{padding:calc(8px + env(safe-area-inset-top,0px)) max(8px,env(safe-area-inset-right,0px)) calc(8px + env(safe-area-inset-bottom,0px)) max(8px,env(safe-area-inset-left,0px))}.settlement-modal{width:100%;max-height:calc(100vh - 16px);max-height:calc(100dvh - env(safe-area-inset-top,0px) - env(safe-area-inset-bottom,0px) - 16px);border-radius:20px;padding:16px}.settlement-modal .section-title{margin:-16px -16px 12px;padding:14px 14px}.settlement-modal .section-title h3{font-size:20px}.settlement-modal .section-title .ghost{min-height:40px;padding:9px 12px;border-radius:14px}.settlement-modal-head{align-items:stretch}.settlement-modal-head .pill{align-self:flex-start}.settlement-modal .form.two-col{grid-template-columns:1fr}.settlement-modal .field.span2{grid-column:1/-1}.settlement-actions{display:grid;grid-template-columns:1fr}.settlement-actions button{width:100%;min-height:48px}}
