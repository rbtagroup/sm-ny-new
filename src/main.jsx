...
const driverWidgetUi = { ConflictBox, Field, Kpi, Modal, SettlementStatusPill, SettlementSummary, StatusPill }
...
function DriverHome({ data, helpers, commit, currentDriver, syncState }) {
  ...
  const cardProps = { data, helpers, expandedShiftId, onExpand: setExpandedShiftId, actions, ui: driverWidgetUi }
